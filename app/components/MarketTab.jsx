...
function FundDetailDialog({ cardDialogRow, getFundCardProps, setCardDialogRow }) {
  ...
  return (
    ...
    >
      <DialogContent
        className="sm:max-w-[calc(100%-2rem)] max-h-[88vh] flex flex-col p-0 overflow-hidden"
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-8 py-4 scrollbar-y-styled">
