...
GRANT EXECUTE ON FUNCTION public.update_user_config_full(jsonb, text, boolean) USING (true);
...
GRANT EXECUTE ON FUNCTION public.get_ytd_percentile(numeric) USING (true);
GRANT EXECUTE ON FUNCTION public.get_ytd_percentile(numeric) TO service_role;

GRANT EXECUTE ON FUNCTION public.update_user_config_partial(jsonb, text, boolean) USING (true);
...
GRANT EXECUTE ON FUNCTION public.check_and_increment_ocr_usage(int) USING (true);
